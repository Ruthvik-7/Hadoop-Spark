...
public class JavaBinaryClassificationMetricsExample {
  public static void main(String[] args) {
    ...
    // $example on$
    String path = "hdfs://master:50000/example/sample_binary_classification_data.txt";
    ...
    // Save and load model
    model.save(sc, "/home/iiit/example/e/LogisticRegressionModel");
    LogisticRegressionModel.load(sc, "/home/iiit/example/e/LogisticRegressionModel");
    // $example off$
    System.out.println("Precision by threshold: " + precision.collect());
    System.out.println("Recall by threshold: " + recall.collect());
    System.out.println("F1 Score by threshold: " + f1Score.collect());
